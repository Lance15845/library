...
public class Chazhaonumbbooks extends JFrame {
	 ...
	 */
	public void Chazhaonumbbooks1 (Books books) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Chazhaonumbbooks frame = new Chazhaonumbbooks(books);
	 ...
	 * Create the frame.
	 */
	public Chazhaonumbbooks(Books books) {
		setTitle("\u7F16\u7801\u67E5\u627E");
