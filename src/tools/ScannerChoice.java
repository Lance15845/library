...
public class ScannerChoice {
    ...
    public static final String BORROW_BOOKS_PAGE = "borrowBooksPage";
    public static final String RETURN_BOOKS_PAGE = "returnBooksPage";
    ...
    public static void changedInfoNext(String oper){
        ...
        do{
            ...
            if ("y".equals(choice) || "Y".equals(choice)){
                ...
                }else if (BORROW_BOOKS_PAGE.equals(oper)){
                    BooksPage.borrowBooksPage();
                }else if (RETURN_BOOKS_PAGE.equals(oper)){
                    BooksPage.returnBooksPage();
                }
