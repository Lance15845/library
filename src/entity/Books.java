...
public  final class Books {
    ...
    public void setBookNumBroughtOut(int bookNumBroughtOut) {
        this.bookNumBroughtOut = bookNumBroughtOut;
    }
    public void setBookNumBorrowed(int bookNumBorrowed) {
        this.bookNumBorrowed = bookNumBorrowed;
    }
